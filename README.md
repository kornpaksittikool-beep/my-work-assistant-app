...
การแก้ไขไฟล์ รันคำสั่ง และเครื่องมืออื่นควรเพิ่มหลังจาก flow หลักนี้ทำงานได้เสถียรแล้ว

### เพิ่มมาหลัง MVP แรก

- Agent เรียก `search_files` และ `read_file` ได้แล้ว — ค้นหาไฟล์ข้ามทุก root ที่อนุญาตพร้อม extension/ช่วงวันปฏิทิน และอ่านเนื้อหา text/markdown/json จริงโดยมีหลักฐาน tool และข้อจำกัดขนาด
